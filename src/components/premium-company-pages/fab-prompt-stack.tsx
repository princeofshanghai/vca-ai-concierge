...
export function FabPromptStack<TValue extends string>({
  ...
  return (
    <div
      className={
        visible
          ? "pointer-events-auto absolute bottom-full right-0 flex flex-col items-end gap-sm pb-md"
          : "pointer-events-none absolute bottom-full right-0 hidden flex-col items-end gap-sm pb-md group-hover:pointer-events-auto group-focus-within:pointer-events-auto [@media(hover:hover)_and_(pointer:fine)]:flex"
      }
    >
